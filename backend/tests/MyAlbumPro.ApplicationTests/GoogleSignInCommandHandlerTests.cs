...
public class GoogleSignInCommandHandlerTests
{
    ...
    [Fact]
    public async Task Handle_ReturnsTokenAndUser()
    {
        ...
        _tokenService.Setup(x => x.Generate(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<IReadOnlyCollection<string>>()))
